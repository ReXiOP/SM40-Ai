...
def plot_one_pixelated_head(x, img, pixelated_img):
    try:
        ...
        cv2.circle(img, circle_center, circle_radius + 3, (5, 30, 205), -1)
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if opt.heads or opt.person:
                            ...
                            org = ((im0.shape[1] - text_size[0]) // 2, (im0.shape[0] + text_size[1]) // 2)
                            font_color = (0, 0, 255)  # BGR color format

                            cv2.putText(im0, text, org, font, font_scale, font_color, font_thickness, cv2.LINE_AA)
